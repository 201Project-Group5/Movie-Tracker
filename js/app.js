...
function generateMovies() {
  ...
  new Movie('the-dark-night', 2004, 'drama');
  new Movie('edge-of-tomorrow', 2014, 'drama');
  new Movie('exiled', 2006, 'drama');
  new Movie('Airplane', 2004, 'comedy');
  new Movie('Big', 2014, 'comedy');
  new Movie('BlacKkKlansman', 2006, 'comedy');
  new Movie('the-dark-night', 2004, 'horror');
  new Movie('edge-of-tomorrow', 2014, 'horror');
  new Movie('exiled', 2006, 'horror');
}
